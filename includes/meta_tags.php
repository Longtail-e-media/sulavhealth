...
//    $seoSources .= '<meta charset="utf-8">' . "\n\n";
    $seoSources .= '<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">' . "\n";
    $seoSources .= '<meta name="robots" content="index,follow,noodp,noydir">' . "\n";
    $seoSources .= '<meta name="Googlebot" content="index,follow,noodp,noydir"/>' . "\n";
    $seoSources .= '<meta name="distribution" content="Global">' . "\n";
    $seoSources .= '<meta name="revisit-after" content="1 Days" />' . "\n\n";

    $seoSources .= '<title>' . $sitetitle . $addsep . $addtitle . '</title>' . "\n";
