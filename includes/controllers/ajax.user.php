<?php
	...
	switch($action)
	{
        ...
        case "updateProfileUser":
            ...
            $record->weight         = (!empty($_REQUEST['weight'])) ? $_REQUEST['weight'] : '';
            $record->height         = (!empty($_REQUEST['height'])) ? $_REQUEST['height'] : '';
            $record->district       = (!empty($_REQUEST['district'])) ? $_REQUEST['district'] : '';
