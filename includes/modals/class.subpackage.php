...
class Subpackage extends DatabaseObject
{
    ...
    protected static $db_fields = array(
        'id', 'slug', 'title', 'title_greek', 'sub_title', 'sub_title_greek', 'brief', 'brief_greek', 'image', 'image2', 'banner_image', 'content', 'content_greek', 'type',
        'meta_title', 'meta_title_greek', 'meta_keywords', 'meta_keywords_greek', 'meta_description', 'meta_description_greek',
        'status', 'sortorder', 'added_date', 'modified_date');
