...
class NewsCategory extends DatabaseObject
{

    protected static $table_name = "tbl_news_category";
    protected static $db_fields = array(
        'id', 'slug', 'title', 'title_greek', 'status', 'sortorder', 'added_date', 'modified_date'
    );

    public $id, $slug, $title, $title_greek, $status, $sortorder, $added_date, $modified_date;
