<script language="javascript">
    ...
    function getLocation() {
        return '<?php echo BASE_URL;?>includes/controllers/ajax.site.php';
    }
    ...
    $(document).ready(function () {
        oTable = $('#example').dataTable({
            ...
            sURL: "<?php echo BASE_URL;?>includes/controllers/ajax.site.php?action=sort",
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (msg.action == 'success') {
                                ...
                                if (actionId == 2)
                                    setTimeout(function () {
                                        window.location.href = "<?php echo ADMIN_URL?>site/list";
                                    }, 3000);
                                if (actionId == 1)
                                    setTimeout(function () {
                                        window.location.href = "<?php echo ADMIN_URL?>site/addEdit";
                                    }, 3000);
                                if (actionId == 0)
                                    setTimeout(function () {
    ...
    /***************************************** View locationns Lists *******************************************/
    function viewSitesList() {
        window.location.href = "<?php echo ADMIN_URL?>site/list";
    }

    function viewChildlist(Re) {
        window.location.href = "<?php echo ADMIN_URL?>site/list/" + Re;
    }
    ...
    function editRecord(Re) {
        window.location.href = "<?php echo ADMIN_URL?>site/addEdit/" + Re;
    }
    ...
    // change default delivery charge to 70 for "Inside Valley"
    $(document).on('change', '#parentId', function () {
        var val = $(this).val();
        if(val == 1){
            $('#delivery_charge').val('70');
        } else {
