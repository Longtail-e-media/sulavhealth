<script language="javascript">
    ...
    function getLocation() {
        return '<?php echo BASE_URL;?>includes/controllers/ajax.frontuser.php';
    }
    ...
    function AddNewUsers() {
        window.location.href = "<?php echo ADMIN_URL?>frontuser/addEdit";
    }

    /***************************************** View Users Lists *******************************************/
    function viewuserslist() {
        window.location.href = "<?php echo ADMIN_URL?>frontuser/list";
    }

    /***************************************** Edit User login Info *******************************************/
    function editRecord(Re) {
        window.location.href = "<?php echo ADMIN_URL?>frontuser/addEdit/" + Re;
    }

    function detail(Re) {
        window.location.href = "<?php echo ADMIN_URL?>frontuser/detail/" + Re;
    }
