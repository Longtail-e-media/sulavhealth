        ...
        jQuery('#offers_frm').validationEngine({
            ...
            onValidationComplete: function (form, status) {
                if (status == true) {
                    ...
                    //         var editorData = CKEDITOR.instances[instance].getData();

                    //         // Remove empty <p> tags
                    //         editorData = editorData.replace(/<p>(\s|&nbsp;)*<\/p>/g, '');

                    //         // Update the editor content with the cleaned data
                    //         CKEDITOR.instances[instance].setData(editorData);

                    //         // Update the textarea linked to the editor
                    //         CKEDITOR.instances[instance].updateElement();
                    //     }
                    // }
