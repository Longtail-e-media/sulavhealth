<script language="javascript">
    ...
    function getLocation() {
        return '<?php echo BASE_URL;?>includes/controllers/ajax.locationn.php';
    }
    ...
    $(document).ready(function () {
        oTable = $('#example').dataTable({
            ...
            sURL: "<?php echo BASE_URL;?>includes/controllers/ajax.locationn.php?action=sort",
    ...
    function editRecord(Re) {
        window.location.href = "<?php echo ADMIN_URL?>locationn/addEdit/" + Re;
    }
