...
if (defined('SEARCH_PAGE')) {
    ...
    $resisearch .= '
        <div class="container mx-auto product-filter position-relative">
            <div class="row">
                <div class="product-filter-side col-xl-2 col-md-4 product_filter_popout">
                 <div class="filter_icon text-end position-absolute" id="filter_close"><i class="fas fa-2x fa-window-close"></i></div>
                    <h2>Filters</h2>
