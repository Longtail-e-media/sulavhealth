...
if (defined('CHECKOUT_PAGE')) {
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="input-item">
                                                    <input type="text" name="address" value="' . ((!empty($checkLogin)) ? $checkLogin->facebook_uid : '') . '" placeholder="' . ("Address") . '">
                                                </div>
                                            </div>
                                            <!--<div class="col-md-6">
                                                <div class="input-item">
    ...
    $checkout_form .= '
                                ...
                                <!--<p><label class="input-info-save mb-0"><input type="checkbox" name="ship_same_add" value="1"> ' . ("Use Address as Shipping Address?") . '</label></p>-->
    ';
    if (empty($checkLogin)) {
