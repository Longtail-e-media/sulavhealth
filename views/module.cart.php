...
if (defined('CHECKOUT_PAGE')) {
                ...
                <div class="col-lg-7 billing-left">
                    <div class="ltn__checkout-inner">
                        <div class="ltn__checkout-single-content mt-50">
                            <h4 class="title-2 pb-10">' . (($lang == "gr") ? "Λεπτομέρειες Τιμολόγησης" : "Billing Details") . '</h4>
    ...
    $checkout_form .= '
                                ...
                                </div>                                <!--<p><label class="input-info-save mb-0"><input type="checkbox" name="ship_same_add" value="1"> ' . (($lang == "gr") ? "Να χρησιμοποιηθεί η διεύθυνση ως διεύθυνση αποστολής;;" : "Use Address as Shipping Address?") . '</label></p>-->
    ';
    if (empty($checkLogin)) {
