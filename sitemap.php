...
$staticblocks = array('home', 'contact-us', 'faq', 'blog');
...
foreach ($pages as $page) {
    $xml .= '<url>
                ...
                <lastmod>' . date('Y-m-dTH:i:sP', strtotime($page->modified_date)) . '</lastmod>
...
//         <lastmod>'.date('Y-m-dTH:i:sP', strtotime($offer->added_date)).'</lastmod>
...
foreach ($packages as $package) {
    ...
    $xml .= '<url>
                ...
                <lastmod>' . date('Y-m-dTH:i:sP', strtotime($package->modified_date)) . '</lastmod>
...
//    $pakgLink = !empty($chkPar) ? '' . $spackage->slug . '' . $spackage->slug : '';
    $xml .= '<url>
                ...
                <lastmod>' . date('Y-m-dTH:i:sP', strtotime($spackage->modified_date)) . '</lastmod>
