<?php
$moduleTablename = "tbl_news_category"; // Database table name
$moduleId = 25;                         // module id >>>>> tbl_modules

if (isset($_GET['page']) && $_GET['page'] == "newscategory" && isset($_GET['mode']) && $_GET['mode'] == "list"):
    ?>
    <h3>
        List Nes Category
        <a class="loadingbar-demo btn medium bg-blue-alt float-right" href="javascript:void(0);" onClick="addNewCategory();">
    ...
    <div class="example-box">
        <div class="example-code">
            <table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
                ...
                <tbody>
                <?php $records = NewsCategory::find_by_sql("SELECT * FROM " . $moduleTablename . " ORDER BY sortorder DESC ");
...
<?php elseif (isset($_GET['mode']) && $_GET['mode'] == "addEdit"):
    if (isset($_GET['id']) && !empty($_GET['id'])):
        $newsCategoryId = addslashes($_REQUEST['id']);
        $newsCategoryInfo = NewsCategory::find_by_id($newsCategoryId);
        $status = ($newsCategoryInfo->status == 1) ? "checked" : " ";
        $unstatus = ($newsCategoryInfo->status == 0) ? "checked" : " ";
    endif;
    ?>
    <h3>
        <?php echo (isset($_GET['id'])) ? 'Edit News Category' : 'Add News Category'; ?>
        <a class="loadingbar-demo btn medium bg-blue-alt float-right" href="javascript:void(0);"
           onClick="viewNewsCategoryList();">
        ...
        <div class="example-code">
            <form action="" class="col-md-12 center-margin" id="articles_frm">
                <div class="form-row">
                    ...
                    <div class="form-input col-md-20">
                        <input placeholder="Title" class="col-md-6 validate[required,length[0,200]]" type="text"
                               name="title" id="title"
                               value="<?php echo !empty($newsCategoryInfo->title) ? $newsCategoryInfo->title : ""; ?>">
                    </div>
                </div>
                ...
                <!--<div class="form-row">
                    ...
                    <div class="form-input col-md-20">
                        <input placeholder="Title Greek" class="col-md-6" type="text" name="title_greek" id="title_greek"
                               value="<?php echo !empty($newsCategoryInfo->title_greek) ? $newsCategoryInfo->title_greek : "";
                ?>">
                    </div>
                </div>-->
                ...
                <input myaction='0' type="hidden" name="idValue" id="idValue"
                       value="<?php echo !empty($newsCategoryInfo->id) ? $newsCategoryInfo->id : 0; ?>"/>
            </form>
        </div>
    </div>
<?php endif; ?>