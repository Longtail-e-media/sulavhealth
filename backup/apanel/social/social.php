                            ...
                            <div class="col-md-1">
                                <a href="javascript:void(0);" onClick="editRecord(<?php echo $record->id; ?>);" class="loadingbar-demo btn small"
                                   title="<?php echo $record->title; ?>">
                                    <!--<img src="<?php echo IMAGE_PATH; ?>social/<?php echo $record->image; ?>" alt="<?php echo $record->title; ?>"
                                         width="25">-->
            ...
            <form action="" class="col-md-10 center-margin" id="social_frm">
                ...
                <div class="form-row">
                    ...
                    <div class="form-input col-md-20">
                        <input placeholder="Social Link Title" class="col-md-4 validate[required,length[0,200]]" type="text" name="title" id="title"
                ...
                <div class="form-row">
                    ...
                    <div class="form-input col-md-20">
                        <input placeholder="Social Link " class="col-md-4 validate[required,length[0,250]]" type="text" name="linksrc" id="linksrc"
                ...
                <div class="form-row add-image">
                    ...
                    <div id="preview_Image"><input type="hidden" name="imageArrayname"
                                                   value="<?php echo !empty($socialInfo->image) ? $socialInfo->image : ""; ?>" class=""/></div>
                </div>
