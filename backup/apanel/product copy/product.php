...
if (isset($_GET['page']) && $_GET['page'] == "product" && isset($_GET['mode']) && $_GET['mode'] == "list"): ?>
    <h3>
        ...
        ?>
        <a class="loadingbar-demo btn medium bg-blue-alt float-right" href="javascript:void(0);" onClick="addNewProduct();">
        ...
        <div class="example-code">
            <table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
                ...
                <tr>
                    ...
                    <th class="text-center">Sub Products</th>
                    <th class="text-center"><?php echo $GLOBALS['basic']['action']; ?></th>
                </tr>
                </thead>

                <tbody>
                <?php $records = Product::find_by_sql("SELECT * FROM " . $moduleTablename . " WHERE type=$typeid ORDER BY sortorder DESC ");
                foreach ($records as $key => $record): ?>
                    <tr id="<?php echo $record->id; ?>">
                        <td style="display:none;"><?php echo $key + 1; ?></td>
                        <td><input type="checkbox" class="bulkCheckbox" bulkId="<?php echo $record->id; ?>"/></td>
                        <td>
                            <a href="javascript:void(0);" title="" class="user-ico clearfix" onclick="editProduct(<?php echo $record->id; ?>);">
                                <span><?php echo $record->title; ?></span>
                            </a>
                        </td>
                        <td class="text-center">
                            <a class="primary-bg medium btn loadingbar-demo" title="" onClick="viewSubProductList(<?php echo $record->id; ?>);"
                               href="javascript:void(0);">
                                <span class="button-content">
                                    <span class="badge bg-orange radius-all-4 mrg5R" title="" data-original-title="Badge with tooltip">
                                        <?php echo $countImages = Subproduct::getTotalSub($record->id); ?>
                                    </span>
...
<?php elseif (isset($_GET['mode']) && $_GET['mode'] == "addEdit"):
    $title_txt = ($typeid == 1) ? 'Product' : 'Package';
            ...
            <form action="" class="col-md-12 center-margin" id="product_frm">
                <div class="form-row">
                    ...
                    <div class="form-input col-md-20">
                        <input placeholder="Product Title" class="col-md-6 validate[required,length[0,200]]" type="text" name="title" id="title"
                ...
                <!--<div class="form-row">
                    ...
                    <div class="form-input col-md-20">
                        <input placeholder="Title Greek" class="col-md-6 validate[required]" type="text" name="title_greek" id="title_greek"
                               value="<?php echo !empty($productInfo->title_greek) ? $productInfo->title_greek : ""; ?>">
                    </div>
                </div>-->
                ...
                <input myaction='0' type="hidden" name="idValue" id="idValue" value="<?php echo !empty($productInfo->id) ? $productInfo->id : 0; ?>"/>
