...
{	
	...
	if($lastpage > 1)
	{
		$pagination .= "<ul>\n";
				if ($page > 1)
					$pagination.= "<li><a href='".$url.'/page/'.$prev."'><i class='fas fa-angle-double-left'></i></a></li>";
				else
					$pagination.= "<li><a href='javascript:void(0);'><i class='fas fa-angle-double-left'></i></a></li>";
				...
				if ($page < $counter - 1)
					$pagination.= "<li><a href='".$url.'/page/'.$next."'><i class='fas fa-angle-double-right'></i></a></li>";
				else
					$pagination.= "<li><a href='javascript:void(0);'><i class='fas fa-angle-double-right'></i></a></li>";
			$pagination.= "</ul>\n";
	}
