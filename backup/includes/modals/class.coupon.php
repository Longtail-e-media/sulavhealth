...
class Coupon extends DatabaseObject
{
    ...
    protected static $table_name = "tbl_coupon";
    protected static $db_fields = array(
        'id', 'slug', 'title', 'title_greek', 'code', 'discount', 'start_date', 'end_date', 'status', 'sortorder', 'added_date', 'modified_date'
    );

    public $id, $slug, $title, $title_greek, $code, $discount, $start_date, $end_date, $status, $sortorder, $added_date, $modified_date;
