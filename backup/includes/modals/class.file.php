...
class File extends DatabaseObject
{
    ...
    protected static $table_name = "tbl_file";
    protected static $db_fields = array('id', 'title', 'file', 'status', 'added_date', 'modified_date', 'sortorder');
    ...
    {
        global $db;
        return self::find_by_sql("SELECT * FROM " . self::$table_name . " WHERE status=1 ORDER BY title ASC");
    }
