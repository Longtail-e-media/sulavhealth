                ...
                <div class="form-row">
                    ...
                    <div class="form-input col-md-20">
                        <?php echo BASE_URL; ?><input placeholder="Slug" class="col-md-3 validate[required,length[0,200]]" type="text" name="slug"
                                                      id="slug" value="<?php echo !empty($articlesInfo->slug) ? $articlesInfo->slug : ""; ?>">
                        <span id="error"></span>
                    </div>
                </div>
                ...
                <!--<div class="form-row">
                    ...
                    <div class="form-input col-md-20">
                        <input placeholder="Title Greek" class="col-md-6" type="text" name="title_greek" id="title_greek"
                               value="<?php echo !empty($articlesInfo->title_greek) ? $articlesInfo->title_greek : "";
                               ?>">
                    </div>
                </div>-->
                            ...
                            <div class="row">
                                ...
                                <!--<div class="col-md-4">
                                    <textarea placeholder="Meta Title Greek" name="meta_title_greek" id="meta_title_greek"
                                              class="character-keyword"><?php echo !empty($articlesInfo->meta_title_greek) ? $articlesInfo->meta_title_greek : ""; ?></textarea>
                                </div>
                                <div class="col-md-4">
                                    <textarea placeholder="Meta Keywords Greek" name="meta_keywords_greek" id="meta_keywords_greek"
                                              class="character-keyword-gr"><?php echo !empty($articlesInfo->meta_keywords_greek) ? $articlesInfo->meta_keywords_greek : ""; ?></textarea>
                                    <div class="keyword-remaining-gr clear input-description">250 characters left</div>
                                </div>
                                <div class="col-md-4">
                                    <textarea placeholder="Meta Description Greek" name="meta_description_greek" id="meta_description_greek"
                                              class="character-description-gr"><?php echo !empty($articlesInfo->meta_description_greek) ? $articlesInfo->meta_description_greek : ""; ?></textarea>
