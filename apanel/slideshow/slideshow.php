            ...
            <form action="" class="col-md-12 center-margin" id="slideshow_frm">
                <div class="form-row">
                    ...
                    <div class="form-input col-md-8">
                        <input placeholder="Slideshow Title (English)" class="col-md-6 validate[required,length[0,50]]"
                ...
                <!--<div class="form-row">
                    ...
                    <div class="form-input col-md-8">
                        <input placeholder="Slideshow Title (Greek)" class="col-md-6 validate[required,length[0,50]]"
                               type="text" name="title_greek" id="title_greek"
                               value="<?php echo !empty($advInfo->title_greek) ? $advInfo->title_greek : ""; ?>">
                    </div>
                </div>-->
                ...
                <div class="form-row add-image <?php echo !empty($imghide) ? $imghide : ''; ?>">
                    ...
                    <div class="form-input col-md-10 uploader1 <?php echo !empty($advInfo->image) ? "hide" : ""; ?>">
                        ...
                        <label>
                            <small>Image Dimensions (1440 px X 960 px)</small>
                        </label>
                    </div>
                ...
                echo isset($_GET['id']) ? '' : 'hide'; ?> videolink">
                    ...
                    <div id="preview_Video">
                        <input type="hidden" name="videoArrayname" value="<?php echo !empty($advInfo->source) ? $advInfo->source : ""; ?>" class=""/>
                    </div>
                </div>
                ...
                <!--<div class="form-row">
                    ...
                    <div class="form-input col-md-8">
                        <textarea name="content_greek" id="content_greek"
                                  class="large-textarea"><?php echo !empty($advInfo->content_greek) ? $advInfo->content_greek : ""; ?></textarea>
                    </div>
                </div>-->
